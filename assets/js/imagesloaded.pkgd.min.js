...
! function(e, t) {
    ...
    function o(e, t, r) {
        ...
        }(n), this.options = i({}, this.options), "function" == typeof t ? r = t : i(this.options, t), r && this.on("always", r), this.getImages(), s && (this.jqDeferred = new s.Deferred), setTimeout(this.check.bind(this))) : h.error("Bad element for imagesLoaded " + (n || e))
    }
    ...
    }, n.prototype = Object.create(r.prototype), n.prototype.check = function() {
